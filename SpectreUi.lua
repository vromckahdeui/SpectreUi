...
-- Spectre Tab (Placed above Main)
local SpectreTab = Window:AddTab("Spectre")

SpectreTab:Button("Destroy UI", function()
    ScreenGui:Destroy()
...
-- Main Tab (Completely clean and ready for elements)
