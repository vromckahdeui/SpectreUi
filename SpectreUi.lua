...
-- Initialization
local Window = Spectre:Window("SPECTRE HUB", "")
local MainTab = Window:AddTab("Main")

MainTab:Button("Welcome to Spectre UI!", function()
    Spectre:Notify("Success", "Library loaded successfully with fixes.", 3)
end)

MainTab:Slider("WalkSpeed", 16, 100, 16, function(val)
...
MainTab:Button("Destroy UI", function()
    ScreenGui:Destroy()
    if CoreGui:FindFirstChild("SpectreToggleGui") then 
        CoreGui.SpectreToggleGui:Destroy() 
    end
end)